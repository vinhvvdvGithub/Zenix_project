					...
					<table class="table display mb-4 dataTablesCard short-one card-table text-black" id="example5">
						...
						<tbody>
							<tr>
								...
								<td>
									<div class="d-flex align-items-center">
										<img src="images/table/Untitled-1.jpg"  class="rounded-circle mr-2 width36 height36" alt="">
										<span>Samuel</span>
									</div>
								</td>
								<td class="wspace-no">
								...
								<td>
									<p class="mb-0 wspace-no">Lorem ipsum dol..<a href="javascript:(0);" class="text-secondary">More</a></p>
								</td>
								<td>
							...
							<tr>
								...
								<td>
									<div class="d-flex align-items-center">
										<img src="images/table/Untitled-2.jpg"  class="rounded-circle mr-2 width36 height36" alt="">
										<span>Cindy</span>
									</div>
								</td>
								<td class="wspace-no">
									<svg class="mr-1" width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
								...
								<td>
									<p class="mb-0 text-dark">Lorem ipsum dol.<a href="javascript:(0);" class="text-secondary">More</a></p>
								</td>
								<td>
							...
							<tr>
								...
								<td>
									<div class="d-flex align-items-center">
										<img src="images/table/Untitled-3.jpg"  class="rounded-circle mr-2 width36 height36" alt="">
										<span>Marquezz</span>
									</div>
								</td>
								<td class="wspace-no">
								...
								<td>
									<p class="mb-0">Lorem ipsum dol..<a href="javascript:(0);" class="text-secondary">More</a></p>
								</td>
								<td>
									<a href="javascript:void(0);" class="btn-link text-success float-right">COMPLETED</a>
								</td>
							...
							<tr>
								...
								<td>
									<div class="d-flex align-items-center">
										<img src="images/table/Untitled-4.jpg"  class="rounded-circle mr-2 width36 height36" alt="">
										<span>David</span>
									</div>
								</td>
								<td class="wspace-no">
								...
								<td>
									<a href="javascript:void(0);" class="btn-link text-light float-right">PENDING</a>
								</td>
							</tr>
							<tr>
								<td class="pr-0">
